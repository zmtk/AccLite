...
{
    public partial class UCdReceipts : UserControl
    {
        ...
        public void filldgv()
        {
            dataGridView1.DataSource = sqlQ.getMData("DReceipts");
        ...
        private void dataGridView1_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            receiptView = new Forms.ReceiptView(RCode, "Domestic");
            receiptView.Show();
        }

        private void btn_ExportSalePrices_Click(object sender, EventArgs e)
        {
            exportSaleData = new Excel.ExportSalePrices("Domestic");
